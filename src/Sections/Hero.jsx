...
const Hero = () => {
  ...
  return (
    <section id='home' className='w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10'>
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-20 xl:pl-32'>
        ...
        <div className='flex justify-starts items-center flex-wrap w-full mt-10 gap-16 '>
          {statistics.map((stat) => (
